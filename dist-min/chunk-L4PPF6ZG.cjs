'use strict';async function s(r,o){r.replaceChildren();let e=document.createElement("div");e.className="idr-auth-panel",e.innerHTML=`
    <style>
  ...
  `,r.appendChild(e);let a=e.querySelector(".error"),i=t=>{a.hidden=!t,a.textContent=t;};e.querySelector('[data-action="login-account"]').addEventListener("click",async()=>{i("");let t=e.querySelector('input[name="entity"]').value,l=e.querySelector('input[name="password"]').value,p=e.querySelector('input[name="persist-account"]').checked;try{await o.client.loginAccount({entityId:t,password:l,persist:p});}catch(n){i(n instanceof Error?n.message:String(n));}});}exports.a=s;